...
public class CustomSeekBarPreferenceMiddle extends Preference implements SeekBar.OnSeekBarChangeListener,
    ...
    public CustomSeekBarPreferenceMiddle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setLayoutResource(R.layout.seekbar_card_middle);
    }

    public CustomSeekBarPreferenceMiddle(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public CustomSeekBarPreferenceMiddle(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context,
                androidx.preference.R.attr.preferenceStyle,
                android.R.attr.preferenceStyle));
    }

    public CustomSeekBarPreferenceMiddle(Context context) {
        this(context, null);
    }
