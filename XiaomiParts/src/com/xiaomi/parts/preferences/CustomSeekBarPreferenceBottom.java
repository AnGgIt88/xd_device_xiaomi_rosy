...
public class CustomSeekBarPreferenceBottom extends Preference implements SeekBar.OnSeekBarChangeListener,
    ...
    public CustomSeekBarPreferenceBottom(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setLayoutResource(R.layout.seekbar_card_bottom);
    }

    public CustomSeekBarPreferenceBottom(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public CustomSeekBarPreferenceBottom(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context,
                androidx.preference.R.attr.preferenceStyle,
                android.R.attr.preferenceStyle));
    }

    public CustomSeekBarPreferenceBottom(Context context) {
        this(context, null);
    }
