...
public class CustomSeekBarPreferenceTop extends Preference implements SeekBar.OnSeekBarChangeListener,
    ...
    public CustomSeekBarPreferenceTop(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setLayoutResource(R.layout.seekbar_card_top);
    }

    public CustomSeekBarPreferenceTop(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public CustomSeekBarPreferenceTop(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context,
                androidx.preference.R.attr.preferenceStyle,
                android.R.attr.preferenceStyle));
    }

    public CustomSeekBarPreferenceTop(Context context) {
        this(context, null);
    }
